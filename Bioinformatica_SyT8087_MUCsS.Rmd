...
knitr::include_graphics("Images/amino-acid-table.jpg")
```
...
shinyNGLVieweR - Visualize and interact with Protein Data Bank (PDB) and structural files in the web browser [GitHub](https://github.com/nvelden/shinyNGLVieweR), [ShinyApp](https://niels-van-der-velden.shinyapps.io/shinyNGLVieweR/)


Probar a cargar la "Structure of the SARS-CoV-2 spike glycoprotein" con el código PBD: **6VXX**. Página del [Protein Data Bank ](https://www.rcsb.org/structure/6vxx).
